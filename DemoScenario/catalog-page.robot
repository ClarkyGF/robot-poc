...
Handle Cookie Modale
    ${confirmElement}=    Wait For Selector    [data-testid="Modal-confirm"]    state=visible

    Run Keyword If    "${confirmElement}" != "None"
        Click    ${confirmElement}
        Wait For Element State    ${confirmElement}    hidden
